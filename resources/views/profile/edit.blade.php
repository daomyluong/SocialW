    ...
    <div class="card border-0 shadow-sm p-4" style="background: white; border-radius: 15px;">
        ...
        <form action="{{ route('profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="file" name="avatar" class="form-control shadow-none mb-2" style="border-radius: 8px;">

                {{-- checkbox ẩn --}}
                <input type="checkbox" name="remove_avatar" id="removeAvatar" hidden>


                <button type="button"
                    onclick="document.getElementById('removeAvatar').checked = true"
            ...
            <div class="d-grid gap-2 mt-4">
                ...
                <a href="{{ route('profile.show', auth()->id()) }}" class="btn btn-link text-decoration-none text-secondary">Hủy</a>
            </div>
        </form>
    </div>
</div>
