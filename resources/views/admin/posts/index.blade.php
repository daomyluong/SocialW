            ...
            <div class="modal-content admin-modal-shell">
                ...
                <div class="modal-footer admin-modal-footer d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 flex-wrap justify-content-end">
                        <form action="{{ route('admin.posts.moderate', $post->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Ẩn/Thay thế nội dung bài viết này?');">
                            @csrf
                            <input type="hidden" name="action" value="hide">
                            <button type="submit" class="btn btn-confirm-grad"><i class="fa-solid fa-lock me-1"></i> Khóa bài</button>
                        </form>
